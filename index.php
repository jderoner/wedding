...
<head>
    ...
    <!-- Optional favicon. Remove comment below to use favicon. -->
    	<!--
...
<!--[if lt IE 7]><p class="chromeframe">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">activate Google Chrome Frame</a> to improve your experience.</p><![endif]-->	
    ...
    <header>
		<nav class="editable" id="menu">
			<ul id="nav">
            	<li><a href="#menu1" class="logo">A & J</a></li>
                <li></li>
                <li></li>
                
                <li><a href="#menu2">Our Story</a></li>
                <li><a href="#menu3">Photos</a></li>
                <li><a href="#menu4">The Wedding</a></li>
                <li><a href="#menu5">Accommodations</a></li>
                <li><a href="#menu6">Gifts</a></li>
                
             </ul>
        </nav>
    </header>
	
    <section id="moving-bg" data-speed="8" data-type="background">
        <div class="container" id="menu1">
            <div class="row editable" id="content-one">
            <div class="border"></div>
                <div class="twelvecol landingContainer">
                	<h1 class="landing">Allie & Jason</h1>
                    <h2 class="date">11.14.2015</h2>
                </div><!-- .twelvecol -->
            </div><!-- .row -->
        </div><!-- .container #menu1 -->
...
We concluded the evening with a fantastic dinner over more champagne from Southold Farm & Cellar, and the weekend continued with ten of our closest friends arriving by train Saturday morning for an amazing day of wine tasting and great company. I couldn’t have asked for a more perfect weekend and owe a great deal of gratitude to all who contributed to making it one of the happiest memories for Allie and me!
        ...
        <div class="container" id="menu3">
            <div class="row editable" id="content-three">
            <div class="border"></div>
            	<article>
                    <h1>Our Photos</h1>
        ...
        <div class="container" id="menu5">
            <div class="row editable" id="content-five">
            <div class="border"></div>
            	<article class="wedinfo">
...
*if you're a nervous flyer, have a drink at Whisky River bar in the “E” terminal in Charlotte before you board. It’s a 23 minute flight in the air, you’ll be fine!
        ...
        <div class="container" id="menu6">
            <div class="row editable" id="content-six">
            <div class="border"></div>
                <article class="wedinfo">
